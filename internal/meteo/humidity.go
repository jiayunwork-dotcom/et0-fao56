...
// Humidity carries the alternative humidity inputs. Exactly one of them is
// enough; when several are present they must agree.
...
// Sources lists the humidity channels that were supplied.
...
// Resolve converts whatever humidity channel was supplied into an actual
// vapour pressure at the given air temperature. The returned label names
...
// Describe renders the supplied channels for reports and error messages.
...
// ValidateRelativeHumidity rejects readings outside the physical range.
...
// MeanRelativeHumidity averages daily extremes after validating both ends.
